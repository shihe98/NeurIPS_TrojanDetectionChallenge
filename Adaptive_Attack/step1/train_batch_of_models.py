...
def train_models(args):
    ...
    for model_idx in range(args.start_idx, args.start_idx + args.num_train):
        ...
        if args.trojan_type == 'clean':  # clean networks
            ...
            clean_model_paths = [os.path.join('../evasive_dataset/reference_models', x, 'model.pt') \
                for x in sorted(os.listdir(os.path.join('../evasive_dataset/reference_models')))]
            print(os.listdir(os.path.join('../evasive_dataset/reference_models')))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='../temp1/',
